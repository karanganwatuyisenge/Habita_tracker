...
class CompletedHabit extends StatefulWidget {
  const CompletedHabit({Key? key}) : super(key: key);

  @override
  State<CompletedHabit> createState() => _CompletedHabitState();
}

class _CompletedHabitState extends State<CompletedHabit> {
